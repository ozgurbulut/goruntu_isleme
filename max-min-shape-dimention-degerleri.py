...
def my_function_1(img_1):
    ...
    print("En kucuk kirmizi renk degeri:",np.min(img_1[:,:,1]))
    print("En kucuk kirmizi renk degeri:",np.max(img_1[:,:,1]))
    print("En kucuk kirmizi renk degeri:",np.min(img_1[:,:,2]))
    print("En kucuk kirmizi renk degeri:",np.max(img_1[:,:,2]))
my_function_1(img_1)    
